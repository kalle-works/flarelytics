...
42 built-in queries + public stats endpoint (no API key needed).
...
# Authenticated query — any of the 42 built-in queries
...
See `.claude/skills/flarelytics/references/queries.md` for the full list of 42 queries.
