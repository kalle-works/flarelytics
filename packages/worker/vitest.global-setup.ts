...
// the tracker package's built IIFE bundle as raw text; under turbo, `test`
...
export default function setup(): void {
  ...
  const artifact = resolve(trackerDir, 'dist/tracker.iife.js');

  if (!existsSync(artifact)) {
    console.log('[vitest] packages/tracker/dist/tracker.iife.js is missing — building @flarelytics/tracker first.');
